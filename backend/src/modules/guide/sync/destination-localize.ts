...
export const DECK_HASHTAG_EXTRAS: Record<string, Record<string, readonly [string, string]>> = {
  dalat: {
    ...
    'spotlight-v3': ['#spotlightdalat', '#hookdalat'],
    'spotlight-v4': ['#spotlightdalat', '#hookdalat'],
    'spotlight-v6': ['#spotlightdalat', '#hookdalat'],
    'summary-note': ['#diadiemdalat', '#reviewdalat'],
  ...
  phanthiet: {
    ...
    'spotlight-v3': ['#spotlightphanthiet', '#reviewphanthiet'],
    'spotlight-v4': ['#spotlightphanthiet', '#reviewphanthiet'],
    'spotlight-v6': ['#spotlightphanthiet', '#reviewphanthiet'],
  ...
  greenland: {
    ...
    'spotlight-v3': ['#spotlightgreenland', '#reviewgreenland'],
    'spotlight-v4': ['#spotlightgreenland', '#reviewgreenland'],
    'spotlight-v6': ['#spotlightgreenland', '#reviewgreenland'],
    'summary-note': ['#diadiemgreenland', '#reviewgreenland'],
