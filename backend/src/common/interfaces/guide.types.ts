...
export interface DeleteGeneratedListsRequest {
  groups?: Array<{ deckId?: string; listIds?: string[] }>;
}

export interface DeleteGeneratedListsResponse {
